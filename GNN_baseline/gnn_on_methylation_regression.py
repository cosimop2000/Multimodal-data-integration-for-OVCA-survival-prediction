...
if __name__ == '__main__':
    ...
    #Instantiate the model, loss function and optimizer5
    model = GCN(num_features=300, hidden_channels=100, num_classes=1)
    ...
    for epoch in range(1000):
        ...
        print(f'Test sqrt of MSE: {test_acc:.4f}')
        if test_acc < best_acc:
            best_acc = test_acc
            torch.save(model, 'methylation_regression3Layers.pt')
