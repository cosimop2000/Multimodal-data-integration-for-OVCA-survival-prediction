...
class SiameseSharedAndSpecificLoss(nn.Module):
    ...
    def forward(self, siamese_code, classification_output, target, t):
        ...
        loss = classification_loss #+ contrastive_loss*0.3
...
class SharedAndSpecificLoss(nn.Module):
    ...
    def forward(self, view1_specific, view1_shared, view2_specific, view2_shared, view3_specific, view3_shared, view4_specific, view4_shared, t):
        # orthogonal restrict
        ...
        orthogonal_loss4 = self.orthogonal_loss(view4_shared, view4_specific)
        ...
        contrastive_loss4 = self.contrastive_loss(view3_shared, view4_shared, t)
        contrastive_loss = contrastive_loss1 + contrastive_loss3 + contrastive_loss4
...
class SiameseSharedAndSpecificClassifier(nn.Module):
    def __init__(self, original_size=[495, 472, 457], view_size=[457, 256, 128], out_size=32, c_n_units=[64, 32]):
        ...
        #View4 specific
        self.specific4_l11 = nn.Linear(original_size[3], view_size[0])
        self.specific4_l1 = nn.Linear(view_size[0], view_size[1])
        self.specific4_l2 = nn.Linear(view_size[1], view_size[2])
        self.specific4_l3 = nn.Linear(view_size[2], out_size)
        ...
        self.shared4_l11 = nn.Linear(original_size[3], view_size[0])
        ...
        # Classification
        self.classification_l1 = nn.Linear(out_size * 8, c_n_units[0]) #6
    ...
    def init_weights(self):
        ...
        init.kaiming_uniform_(self.specific3_l1.weight)
        init.kaiming_uniform_(self.specific3_l2.weight)
        init.kaiming_uniform_(self.specific3_l3.weight)

        init.kaiming_uniform_(self.specific4_l1.weight)
        init.kaiming_uniform_(self.specific4_l2.weight)
        init.kaiming_uniform_(self.specific4_l3.weight)
    ...
    def forward(self, view1_input, view2_input, view3_input, view4_input): #view3_input
        # View1
        ...
        # View4
        view4_specific11 = F.relu(self.specific4_l11(view4_input))
        view4_specific1 = F.relu(self.specific4_l1(view4_specific11))
        view4_specific2 = F.relu(self.specific4_l2(view4_specific1))
        view4_specific3 = F.relu(self.specific4_l3(view4_specific2))

        view4_shared11 = F.relu(self.shared4_l11(view4_input))
        view4_shared1 = F.relu(self.shared_l1(view4_shared11))
        view4_shared2 = F.relu(self.shared_l2(view4_shared1))
        view4_shared3 = F.relu(self.shared_l3(view4_shared2))

        # Classification
        classification_input = torch.cat([view1_specific3, view1_shared3, view2_shared3, view2_specific3, view3_shared3, view3_specific3, view4_shared3, view4_specific3], dim=1)
        ...
        return view1_specific3, view1_shared3, view2_specific3, view2_shared3, \
               view3_specific3, view3_shared3, view4_specific3, view4_shared3, siamese_code, classification_output
...
class SharedAndSpecific1(nn.Module):
    def __init__(self, view_size=[495, 472, 457], n_unit=[457, 457, 457], out_size=256):
        ...
        self.shared41 = nn.Linear(view_size[3], n_unit[3])
        self.shared42 = nn.Linear(n_unit[3], out_size)
        self.specific41 = nn.Linear(view_size[3], n_unit[3])
        self.specific42 = nn.Linear(n_unit[3], out_size)

    def forward(self, view1_input, view2_input, view3_input, view4_input):
        # View1
        ...
        # View4
        view4_specific1 = F.relu(self.specific41(view4_input))
        view4_specific = F.relu(self.specific42(view4_specific1))
        view4_shared1 = F.relu(self.shared41(view4_input))
        view4_shared = F.relu(self.shared42(view4_shared1))

        return view1_specific, view1_shared, view2_specific, view2_shared, view3_specific, view3_shared, view4_specific, view4_shared
...
class SharedAndSpecific2(nn.Module):
    def __init__(self, view_size=[3000, 1840]):
        ...
        # View4
        self.shared4 = nn.Linear(view_size[0], view_size[1])
        self.specific4 = nn.Linear(view_size[0], view_size[1])

    def forward(self, input_view1_specific, input_view1_shared, input_view2_specific, input_view2_shared, input_view3_specific, input_view3_shared, input_view4_specific, input_view4_shared):
        # View1
        ...
        # View4
        view4_specific = F.relu(self.specific4(input_view4_specific))
        view4_shared = F.relu(self.shared4(input_view4_shared))
